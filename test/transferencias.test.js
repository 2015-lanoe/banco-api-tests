...
describe('transferencias', () => {
    ...
    describe('GET /transferencias/{id}', () => {
        it ('Deve retornar 200 e dados iguais ao registro de transferencia contido no banco de dados quando o ID for válido' , async () => {
            const resposta = await request(process.env.BASE_URL)
    ...
    describe('GET /transferencias', () => {
        it ('Deve Retornar 10 elementos na paginação qdo informar limite de 10 registros' , async() => {
            const resposta = await request(process.env.BASE_URL)
